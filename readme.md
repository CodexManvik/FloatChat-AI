...
**1. Clone the Repository:** git clone [https://github.com/your-username/float-chat.git](https://github.com/your-username/float-chat.git)  
cd float-chat

**2. Install Dependencies:** pip install -r requirements.txt

*(Note: You will need to create a requirements.txt file from your environment)* **3. Set up Ollama:** Pull the necessary LLM and embedding models.  
...
**5. Create and Populate the Vector Database:** Run the data\_chroma.py script to generate embeddings and populate ChromaDB. This may take some time.  
python data\_chroma.py

**6. Run the Backend API:** Start the FastAPI server in a terminal.  
uvicorn main:app --reload

The API will be available at http://127.0.0.1:8000.  
**7. Run the Frontend Application:** Open a second terminal and start the Streamlit app.  
